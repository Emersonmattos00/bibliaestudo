// dados/harpa-dados.js
// Harpa Cristã - Hinário Evangélico Completo
// Estrutura: window.HARPA_DATA = { hinos: [{ numero, titulo, letra }] }
...
const HARPA_DATA = {
    hinos: [
        ...
        if (typeof window !== 'undefined') {
            window.HARPA_DATA = HARPA_DATA;
        }

        // Para Node.js/CommonJS
        if (typeof module !== 'undefined' && module.exports) {
            module.exports = { HARPA_DATA };
        }