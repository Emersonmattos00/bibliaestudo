...
function diagnosticarFlipbook() {
    console.log('=== DIAGNÓSTICO FLIPBOOK ===');
    console.log('Container .ej-book:', document.querySelector('.ej-book'));
    console.log('Filhos do container:', document.querySelectorAll('.ej-book > *').length);
    console.log('Turn disponível:', typeof $.fn.turn);
    
    const container = $('.ej-book');
    console.log('Elemento jQuery:', container.length);
        ...
        container.turn({
            ...
            when: {
                turned: function(e, page) {
                    console.log('Página virada:', page);
                }
            }
        });
        
        console.log('Turn inicializado:', container.data('turn') ? 'SIM' : 'NÃO');
        console.log('Total de páginas:', container.turn('pages'));
    }
}
